  ...
  return (
    <section>
      <a
        ...
        className="flex flex-col gap-3 rounded-lg border bg-card p-5 hover:bg-muted/40 focus-visible:ring-3 focus-visible:ring-ring/50 sm:flex-row sm:items-center sm:justify-between"
      ...
      >
        ...
        <span className="shrink-0 text-sm font-medium">{t("cta")}</span>
      </a>
    </section>
  );
}
