...
export const OPS_UPDATED_AT = "2026-08-28T15:27:00+09:00";
...
export const DAY_TWO_RECEIPT = {
  ...
  description:
    "Shot2 24h: likes 0, retweets 0, quotes 0, replies 0, views 89. Shot1 24h: likes 0, retweets 0, quotes 0, replies 0, views 34. / still redirects to /en (PR #29). Reviews persist on Neon. Ranking 5 stays file-based. Video work stopped. Nothing posted. Next X is a thought-quote of someone else's post, not a site receipt. Screening continues (like+follow+reply). X API still user-not-enrolled.",
  facts: [
    {
...
export const OPS_RESULTS: OpsResult[] = [
  ...
  },
  {
    ...
    date: "2026-08-27",
    kind: "x",
    headline: copy("3h · article", {
      ko: "3시간 · 아티클",
      ja: "3h · 記事",
      "zh-CN": "3 小时 · 长文",
      "zh-TW": "3 小時 · 長文",
    }),
    detail: copy("X스카우트. likes 0, retweets 0, quotes 0, replies 0, views 8.", {
      ko: "X스카우트. 좋아요 0, 리트윗 0, 인용 0, 답글 0, 조회 8.",
      ja: "X스카우트。いいね 0、リポスト 0、引用 0、返信 0、表示 8。",
      "zh-CN": "X스카우트。喜欢 0、转帖 0、引用 0、回复 0、浏览 8。",
      "zh-TW": "X스카우트。喜歡 0、轉發 0、引用 0、回覆 0、瀏覽 8。",
    }),
    href: "https://x.com/daon_kwak/status/2092880945489539472",
  },
  {
    id: "2026-08-27-shot2-3h",
    date: "2026-08-27",
    kind: "x",
    headline: copy("3h · first-rank QT", {
      ko: "3시간 · 1순위 QT",
      ja: "3h · 最優先 QT",
      "zh-CN": "3 小时 · 第一优先 QT",
      "zh-TW": "3 小時 · 第一優先 QT",
    }),
    detail: copy("X스카우트. likes 0, retweets 0, quotes 0, replies 0, views 29.", {
      ko: "X스카우트. 좋아요 0, 리트윗 0, 인용 0, 답글 0, 조회 29.",
      ja: "X스카우트。いいね 0、リポスト 0、引用 0、返信 0、表示 29。",
      "zh-CN": "X스카우트。喜欢 0、转帖 0、引用 0、回复 0、浏览 29。",
      "zh-TW": "X스카우트。喜歡 0、轉發 0、引用 0、回覆 0、瀏覽 29。",
    }),
    href: "https://x.com/daon_kwak/status/2092861599325229402",
  },
  {
  ...
  },
  {
    ...
    date: "2026-08-27",
    kind: "x",
    headline: copy("1h · first-rank QT", {
      ko: "1시간 · 1순위 QT",
      ja: "1h · 最優先 QT",
      "zh-CN": "1 小时 · 第一优先 QT",
      "zh-TW": "1 小時 · 第一優先 QT",
    }),
    detail: copy("X스카우트. likes 0, retweets 0, quotes 0, replies 0, views 19.", {
      ko: "X스카우트. 좋아요 0, 리트윗 0, 인용 0, 답글 0, 조회 19.",
      ja: "X스카우트。いいね 0、リポスト 0、引用 0、返信 0、表示 19。",
      "zh-CN": "X스카우트。喜欢 0、转帖 0、引用 0、回复 0、浏览 19。",
